  ...
  <div class="row">
      ...
      <div class="col-md-6">
          <h3 class="mb-5 heading-pricing ftco-animate text-white">Drinks</h3>
            @foreach ($menuDrinks as $drinks)
                <div class="pricing-entry d-flex ftco-animate">
                        <div class="img" style="background-image: url({{ asset('assets/images/'.$drinks->image.'') }});"></div>
                        <div class="desc pl-3">
                            <div class="d-flex text align-items-center">
                  ...
                  <div class="row">
                    @foreach ($menuDrinks as $drinks)
                            <div class="col-md-4 text-center">
                                <div class="menu-wrap">
                                    <a href="{{ route('product.single',$drinks->id) }}" class="menu-img img mb-4" style="background-image:url({{ asset('assets/images/'.$drinks->image.'') }});"></a>
                                    <div class="text">
                                        <h3><a href="{{ route('product.single',$drinks->id) }}">{{$drinks->name}}</a></h3>
                                        <p>{{$drinks->description}}</p>
                                        <p class="price"><span>${{$drinks->price}}</span></p>
                                        <p><a href="{{ route('product.single',$drinks->id) }}" class="btn btn-primary btn-outline-primary">Add to cart</a></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
