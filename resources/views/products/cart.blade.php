    ...
    @endif
              ...
              <div class="cart-list">
                  <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                          <td class="product-remove"><a href="{{ route('cart.product.delete',$cart->prod_id) }}"><span class="icon-close"></span></a></td>
      ...
      <div class="row justify-content-end">
          <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
            ...
            <p class="alert alert-warning">You don't have products in the Cart!</p>
     }
     @endif
      </div>
