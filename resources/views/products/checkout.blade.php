    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <form method="POST" action="{{ route('procceed.checkout') }}" class="billing-form ftco-bg-dark p-3 p-md-5">
                    @csrf
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="select-wrap">
                                    ...
                                    <select name="state" id="" class="form-select  text-dark">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea  name="address" class="form-control" placeholder="House number and street name"></textarea>
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                value="{{ Session::get('price') }}"  placeholder="">
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col-md-12">
